-- Fix RLS infinite recursion issue only
-- This script fixes the RLS policies without touching the function

-- Step 1: Disable RLS temporarily
ALTER TABLE public.profiles DISABLE ROW LEVEL SECURITY;

-- Step 2: Drop all existing policies to prevent infinite recursion
