-- Fix Create User button with proper foreign key handling
-- This script creates users in auth.users first, then profiles
...
-- Step 3: Create a function that properly handles the foreign key constraint
