-- Fix Create User button with a different UUID
-- This script uses a different UUID to avoid collisions
...
-- Step 4: Test direct insert with a completely different UUID
