-- Fix Create User button with proper auth.users table insertion
...
-- Step 2: Drop and recreate the create_username_user function with proper auth.users insertion
...
BEGIN
  ...
  -- First, create the user in auth.users table with a simple password hash
