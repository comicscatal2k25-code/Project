-- RBAC Migration: Clean version that handles all RLS policy dependencies
-- This migration completely removes all policies before altering the role column

-- Step 1: Disable RLS temporarily to remove all policies
ALTER TABLE public.profiles DISABLE ROW LEVEL SECURITY;

-- Step 2: Drop ALL existing policies (this will remove any we missed)
DO $$
DECLARE
    pol RECORD;
BEGIN
...
-- Step 13: Create function to log audit events
...
-- Step 14: Create a function to check if RBAC is enabled
