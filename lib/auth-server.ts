...
/**
 * Get the current user's profile with role information (SERVER-SIDE)
...
/**
 * Get all permissions for the current user's role (SERVER-SIDE)
 */
...
/**
 * Check if user can create/edit comics (SERVER-SIDE)
 */
...
/**
 * Check if user can manage Shopify integration (SERVER-SIDE)
 */
...
/**
 * Check if user can run reports (SERVER-SIDE)
 */
...
/**
 * Check if user can manage settings (SERVER-SIDE)
 */
